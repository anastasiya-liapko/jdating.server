...
$next_order['jewish_name']='asc';
		...
		<div class="content-header">
			<div class="btn-wrap">
				<h2><a href="#" class="back-btn"><span class="fa fa-arrow-circle-left"></span></a> '."Ждут звонка".' </h2>
...
<option value="0" '.($item["jewish_name"]=="0"?"selected":"").'>Нет</option> 
	...
	$actions['edit_page'] = function()
	{
		...
		$html = '
			<h1 style="line-height: 30px"> Редактирование <br /><small>'."Ждут звонка".' #'.$id.'</small></h1>
			<form class="form" enctype="multipart/form-data" method="POST">
...
$jewish_name_values = '[{"text":"Есть", "value":"1"},{"text":"Нет", "value":"0"}]';
	...
	echo masterRender("Ждут звонка", $content, 8);
